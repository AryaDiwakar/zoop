    ...
    <form onSubmit={onSubmit} className="space-y-6">
      <div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Input label="Student Name *" name="name" required placeholder="Full name" />
          <Input label="Roll Number (manual, optional)" name="rollNumber" placeholder="Auto-generated if empty" />
          <Input label="Parent Name" name="parentName" />
          <Input label="Mobile *" name="mobile" required placeholder="+91 …" />
          <Input label="Alternate Number" name="altMobile" />
      ...
      <div className="flex items-center gap-2">
        <Button type="submit" disabled={loading}>{loading ? "Admitting…" : "Admit Student"}</Button>
